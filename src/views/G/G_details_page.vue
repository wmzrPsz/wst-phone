...
<style lang="less">
 ...
 <script>
 import { getCityRouteDetailsUrl,getRouteContpy,selectCommentUrl,getConsultUrl,saveCollectionUrl,deleteCollectionUrl,refundInforUrl} from "@/utils/getData";
 ...
 import ajax from '@/utils/fetch';
  ...
  data(){
    return {
      ...
      productType:5,//1.包车租车2.短程接送3.接送机4常规路线5.当地参团6.游轮7.景点门票9.酒店10.保险11.当地玩家12.旅游定制-导游13.旅游定制-司兼导14包车/租车-导游//15包车/租车-司兼导
      imgtyp:'',
      show:false,
      show1:false,
      refund:'',//退款
