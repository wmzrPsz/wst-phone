<template>
	<div class="indexlis">
		...
		<div class="dingjia">
			...
			<div class="Success">
				<div class="beijingtu Success_a"><img src="../../assets/img/A/zccg_succes_icon@2x.png"></div>
			...
			<div class="Success_b">
				...
				<router-link to="/F_details">
				<button class="font-14 float_right Success_c" v-if="tyslit==1">返回常规路线</button>
				</router-link>
...
export default {
	...
	methods:{
		...
		cakclick:function(){
			this.$router.push({
				path:"/orderlist_b/"+this.$route.params.routeid+"/"+this.tyslit,
			})
		},
	}
}
