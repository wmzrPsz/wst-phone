  ...
  <div class="index">
   ...
   <div class="Choose_a_room_b">
      <div class="Choose_a_room_b_j">
       <div class="martop">
       	<div class="float_left font-16 martop_jia">{{slist.introduction}}</div>
       </div>
       	<div>
    ...
    <div class="Choose_a_room_d_z">
      ...
      <div class="refund_z">
      <div class="font-14 gameplayer_f">性别:{{slist.sex|sex}}/年龄:{{slist.age}}/地区:{{slist.cityName}}</div>
      <div class="refund_a font-12"><span v-for="(list,index) in tagContent" :key="index">资深当地人</span></div>
    ...
    <div>
     <div class="Car_renting_z" v-for="(stycan,index) in can" :key="index" >
        <div class="float_left beijingtu Car_renting"><img :src="stycan.photo"></div>
        <div class="float_right Car_renting_a">
          <div class="font-14">{{stycan.title}}</div>
          <div class="font-12 color-b Car_renting_b">
            {{stycan.scenice}}
          </div>
          <div>
            <div class="float_left"><i class="font-12 color-h">￥</i><i class="font-14 color-h">{{stycan.price}}</i><i class="font-12">/起</i></div>
     ...
     <div class="refund_z refun_jia">
      ...
      <div class="refund_d_d font-14" v-for="(list,index) in listyp" :key="index">
          ...
          <span class="refund_d_f beijingtu"><img :src="list.contentList[0].img"></span>
      </div>
		 </div>
      <!--用户点评-->
